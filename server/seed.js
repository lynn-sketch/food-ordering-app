...
async function main() {
  const uri = "mongodb+srv://varchodi:greenov@cluster0.elkzdh3.mongodb.net/?retryWrites=true&w=majority";
  ...
  try {
    ...
    const insert = await categoriesCollection.insertMany(categories);
    ...
    const p = await productsCollection.insertMany(products);
    console.log("ins: ", p);
    //console.log("db: ", db);
  } catch (e) {
    console.error(e);
